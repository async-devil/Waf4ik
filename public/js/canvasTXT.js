...
const canvasTxt = {
    ...
    drawText: function (ctx, mytext, x, y, width, height) {
        ...
        const yEnd = y + height;
        if (this.textSize) {
            console.error('%cCanvas-Txt:', 'font-weight: bold;', 'textSize is depricated and has been renamed to fontSize');
        }
        ...
        const charHeight = this.lineHeight ? this.lineHeight : this.getTextHeight(ctx, mytext, style); //close approximation of height with width
...
//# sourceMappingURL=canvasTXT.js.map